...
INSERT INTO `goadmin_session` VALUES (7,'b85e8d6b-197a-42f8-9836-73753f627a3f','{\"user_id\":1}','2020-03-26 08:59:51','2020-03-26 08:59:51');
...
CREATE TABLE `topics` (
  ...
  `deleted_at` int(10) unsigned DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='讨论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-26 10:54:25
